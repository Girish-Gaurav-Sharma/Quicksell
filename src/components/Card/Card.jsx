    ...
    <div className="cardContainer">
      <div className="cardHeading">
        ...
        >
          ...
          <img
            className="image"
            src="https://uxwing.com/wp-content/themes/uxwing/download/peoples-avatars/employee-icon.svg"
            alt="UserImage"
          />
        </div>
      </div>
      <div className="cardTitle">
        {!isStatus &&
          (
            status === "Backlog" ? (
              ...
              <path d="M7 13C10.3137 13 13 10.3137 13 7C13 3.68629 10.3137 1 7 1C3.68629 1 1 3.68629 1 7C1 10.3137 3.68629 13 7 13Z" stroke="#95999F" strokeWidth="2" stroke-dasharray="1.4 1.74"/>
              </svg>
              </div>
              ...
              <path d="M10 7C10 5.34315 8.65685 4 7 4C5.34315 4 4 5.34315 4 7C4 8.65685 5.34315 10 7 10C8.65685 10 10 8.65685 10 7Z" stroke="#5E6AD2" strokeWidth="6" stroke-dasharray="18.85 100"/>
        ...
        <span className="truncateTitle">{title}</span>
      </div>

      <div className="cardTags">
        {!isPriority ? (
          <div className="priorityIcons">
            {priority === 0 ? (
              <div className="priorityLogoContainer">
                <svg className="priorityLogo" width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <div className="priorityLogoContainer">
                <svg className="priorityLogo" width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        {tag?.map((element, index) => {
          return (
            <div key={index} className="tags">
              {" "}
              <span className="dot">•</span> <div className="tagName">{element}</div>
            </div>
          );
        })}
      </div>
